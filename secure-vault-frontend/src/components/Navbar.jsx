    ...
    <nav className="bg-white border-b border-gray-200 shadow-sm">
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <span className="text-gray-600 text-sm font-medium">{user?.username}</span>
          <button
          ...
          <button
            ...
            className="px-3 py-2 text-red-600 hover:bg-red-50 font-semibold rounded-lg transition duration-200 text-sm"
          >
            Logout
          </button>
        </div>
